...
// Upstream https://github.com/mozilla/source-map/blob/master/lib/binary-search.js
// @ts-nocheck
...
function search(aNeedle, aHaystack, aCompare, aBias) {
  ...
  var index = recursiveSearch(-1, aHaystack.length, aNeedle, aHaystack,
                              aCompare, aBias || GREATEST_LOWER_BOUND);
  if (index < 0) {
    return -1;
  }
...
export { search, LEAST_UPPER_BOUND, GREATEST_LOWER_BOUND };
