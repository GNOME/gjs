...
// Upstream https://github.com/mozilla/source-map/blob/master/lib/util.js
// @ts-nocheck
...
export function normalize(aPath) {
  ...
  var isAbsolute = isAbsolute2(path);
...
export const toSetString = supportsNullProto ? identity : toSetString2;

function fromSetString2(aStr) {
  if (isProtoString(aStr)) {
    return aStr.slice(1);
  }
...
export const fromSetString = supportsNullProto ? identity : fromSetString2;
