...
// @ts-ignore
const _byteArrayNative, { toGBytes, toString } = load_internal_module("_byteArrayNative");
...
// @ts-ignore
export const { fromGBytes, fromString, toGBytes, toString } = _byteArrayNative;
