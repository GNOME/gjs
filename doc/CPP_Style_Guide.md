...
GJS is currently written using C++20 conforming code, although we
...
reasonable) be standard, portable, and modern C++20 code.
...
### Supported C++20 Language and Library Features

While GJS and SpiderMonkey use C++20, not all features are available in
