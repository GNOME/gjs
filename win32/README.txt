...
(64-bit/x64 builds)
JS_STANDALONE=1 ../mozjs-60.1.0/js/src/configure --enable-nspr-build --host=x86_64-pc-mingw32 --target=x86_64-pc-mingw32 --prefix=--prefix=<some_prefix> --disable-jemalloc

(32-bit builds)
JS_STANDALONE=1 ../mozjs-60.1.0/js/src/configure --enable-nspr-build --prefix=<some_prefix> --disable-jemalloc
