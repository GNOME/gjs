...
const TestIface = new TextDecoder().decode(
    Gio.resources_lookup_data('/org/gjs/jsunit/org.gnome.gjs.Test.xml',
...
// NOTE: If you add stuff here, you need to update org.gnome.gjs.Test.xml.
class Test {
    constructor() {
